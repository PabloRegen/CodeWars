...
var isSquare = function(n){
  return Math.round(Math.sqrt(n)) === Math.sqrt(n) ? true : false
};
...
// Solution #3: Refer to Bitwise Operators. https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Bitwise_Operators
var isSquare = function(n){
  var s = Math.sqrt(n);
  return s === (s | 0);
};