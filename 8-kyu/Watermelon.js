...
// Solution #2: Will return true or false. No need to specify it
function divide(weight){
  return weight > 2 && weight % 2 === 0;
}


// Solution #3: Preferred. If weight is even then weight % 2 === 0 (false). !0 (!false) returns true. True && true returns true.
function divide(weight){
